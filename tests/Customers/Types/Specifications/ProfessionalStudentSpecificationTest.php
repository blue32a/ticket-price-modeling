...
{
    private ProfessionalStudentSpecification $specification;
    ...
    {
        $this->specification = new ProfessionalStudentSpecification();
    }
     ...
     * @test
     */
    public function 顧客が専門学校以外の学生証明書を持っていたらfalseを返す(): void
    {
