...
class LateShowPolicyTest extends TestCase
{
    private LateShowPolicy $policy;

    public function setUp(): void
    {
        $this->policy = new LateShowPolicy();
    }

    #[Test]
    public function 顧客区分が一般の場合はチケット料金1300円が返る(): void
    {
    ...
    #[Test]
    public function 顧客区分が大学生の場合はチケット料金1300円が返る(): void
    {
    ...
    #[Test]
    public function 顧客区分が専門学生の場合はチケット料金1300円が返る(): void
    {
