...
$price = PriceCalculation::caluculation(
    new PlayStartDateTime(new DateTimeImmutable('2021-12-02 10:00:00')),
    $middleSchoolStudent
);
...
$price = PriceCalculation::caluculation(
    new PlayStartDateTime(new DateTimeImmutable('2021-12-04 22:00:00')),
    $senior
);
...
$price = PriceCalculation::caluculation(
    new PlayStartDateTime(new DateTimeImmutable('2021-12-05 15:00:00')),
    $general
);
